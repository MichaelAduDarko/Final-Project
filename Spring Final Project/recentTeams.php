...
<body>
    ...
    <div class="content" style="margin-top: 20px">
        <h1 class="display-6" style="text-align:center; border: 2px solid DodgerBlue"><b>Recent Added Teams</b></h1>
        <hr>
    ...
    <?php
        ...
        $query= "select * from nba_team order by founded desc limit 5";
